                  ...
                  <div key={item.title} className="lp-feature-item-wrap">
                    ...
                    >
                      <span className="lp-feature-item-top">
                        <span
                          className="lp-feature-item-logo"
                          aria-hidden="true"
                        >
                          {item.logo}
                        </span>
                        {active ? (
                          <span className="lp-feature-item-sub">
                            {item.subtitle}
                          </span>
                        ) : null}
                      </span>
                      <span className="lp-feature-item-title">
                        {item.title}
                      </span>
                      {active ? (
                        <span className="lp-feature-item-desc">
                          {item.description}
                        </span>
                      ) : null}
                      {active ? (
                    ...
                    {active ? (
                      <div className="lp-mobile-stage" aria-hidden="true">
                        <div
                          className={`lp-media-browser lp-media-${item.accentClass}`}
                        >
